...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.jpg" alt="Trang chủ Perfume Store" title="Trang chủ Perfume Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Perfume Store</a> - All rights reserved © 2022 - Designed by
            <span style="color: #eee; font-weight: bold">group 5th</span></p>
    </div>`);
}
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                ...
                <li>Thanh toán linh hoạt: tiền mặt, Momo/Zalo Pay, trả góp</li>
                <li>Trải nghiệm sản phẩm tại nhà</li>
                <li>Lỗi đổi tại nhà trong 1 ngày</li>
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:12345678" style="color:	#0000FF">12345678</a>
                </li>
            </ul>
        </section>
    </div>`);
